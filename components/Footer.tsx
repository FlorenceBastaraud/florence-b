    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          opacity: showTop ? 1 : 0,
          transform: showTop ? "translateY(0)" : "translateY(0.75rem)",
          pointerEvents: showTop ? "auto" : "none",
        }}
        onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "var(--accent)"; (e.currentTarget as HTMLElement).style.color = "var(--accent)"; }}
        onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "var(--border)"; (e.currentTarget as HTMLElement).style.color = "rgba(245,240,235,0.4)"; }}
      >
      ...
      <footer style={{ borderTop: "1px solid var(--border)", marginTop: "4rem" }}>
        <div className="container" style={{ paddingTop: "2.5rem", paddingBottom: "2.5rem" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "1.25rem", marginBottom: "2rem" }}>
            <a href="https://github.com/florenceBastaraud" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
              style={{ color: "rgba(245,240,235,0.25)", transition: "color 0.3s" }}
            ...
            <a href="https://www.linkedin.com/in/florence-bastaraud/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
              style={{ color: "rgba(245,240,235,0.25)", transition: "color 0.3s" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "var(--fg)")}
              onMouseLeave={(e) => (e.currentTarget.style.color = "rgba(245,240,235,0.25)")}
            >
            ...
            <a href="mailto:contact@florence-b.com" aria-label="Email"
              style={{ color: "rgba(245,240,235,0.25)", transition: "color 0.3s" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "var(--fg)")}
              onMouseLeave={(e) => (e.currentTarget.style.color = "rgba(245,240,235,0.25)")}
            >
